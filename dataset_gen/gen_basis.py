...
for _ in tqdm(range(num_train_perc)):
    ...
    if base_num == 1:
        ...
        train_high_corr.append(0)
    if base_num == 2:
        base = 'ladder'
        width_basis = np.random.choice(range(8, 12))
        train_high_corr.append(1)
    if base_num == 3:
        base = 'wheel'
...
np.save(f'data/tSPMotif-{global_b}/raw/train.npy',
        (edge_index_list, label_list, base_list,ground_truth_list, role_id_list, pos_list, motif_id_list,train_high_corr))
